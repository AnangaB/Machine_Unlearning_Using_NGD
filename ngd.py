...
# most code and commments in this page is from https://github.com/YiwenShaoStephen/NGD-SGD/blob/master/ngd.py
...
class OnlineNaturalGradient:
    ...
    def _precondition_directions3(self, X_t, tr_X_Xt):
        ...
        #the above line is  deprecated, so replacing with following linr
